...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: _objectSpread(_objectSpread({}, Object(vuex__WEBPACK_IMPORTED_MODULE_1__["mapActions"])(['TRIGGER_UPDATE_USER', 'TRIGGER_UPDATE_ERRORS'])), {}, {
      ...
      if (this.$v.$invalid) {
        ...
        axios.get('/sanctum/csrf-cookie').then(function (response) {
          axios.post('/login', {
            ...
            _this.TRIGGER_UPDATE_USER(success.data);
            ...
            _this.TRIGGER_UPDATE_ERRORS(error.response.data.errors);
          });
        });
      }
    }
                ...
                _vm.$v.email.$error
                  ? _c("div", { staticClass: "invalid-feedback d-block" }, [
                      ...
                      !_vm.$v.email.minLength
                        ? _c("span", [
                            _vm._v("Email must be valid email address")
                          ])
                        : _vm._e(),
                      _vm._v(" "),
                      !_vm.$v.email.maxLength
                        ? _c("span", [
                            _vm._v("Email must be maximum 255 characters")
                          ])
                        : _vm._e()
                    ])
                  : _vm._e()
